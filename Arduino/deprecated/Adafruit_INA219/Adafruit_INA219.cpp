...
void Adafruit_INA219::ina219SetCalibration_32V_2A(void)
{
  ...
  // MinimumLSB = 0.000061  0.0002142245073            (61uA per bit)
  // MaximumLSB = MaxExpected_I/4096
  // MaximumLSB = 0,000488  0.001708984375            (488uA per bit)
  ...
  // Cal = 4096 (0x1000) 5120 (0x1400)
  
  ina219_calValue = 5120;
  
  // 6. Calculate the power LSB
  // PowerLSB = 20 * CurrentLSB
  // PowerLSB = 0.002 (2mW per bit) 0.004 W
  
  // 7. Compute the maximum current and shunt voltage values before overflow
  //
  // Max_Current = Current_LSB * 32767
  // Max_Current = 3.2767A before overflow 6.5534 A
  //
  ...
  ina219_currentDivider_mA = 5;  // Current LSB = 100uA per bit (1000/100 = 10) 1000/200=5
  ina219_powerDivider_mW = 4;     // Power LSB = 1mW per bit (2/1) 4/1
