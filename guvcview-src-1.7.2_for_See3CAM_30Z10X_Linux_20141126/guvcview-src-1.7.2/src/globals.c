...
//Start of e-con
int i;
	g_snprintf(global->WVcaption,18,"See3CAM GUVCVIdeo");
	...
	global->FX320_imgFPath = g_new(pchar, 2);
	global->FX320_imgFPath[1] = g_strdup(home);
	global->FX320_imgFPath[0] = g_strdup("See3CAM_image.jpg");

	global->FX320_imgFName= g_new(pchar,8);
for(i=0;i<8;i++){
...
//	printf("FX320_imgFName[%d] : %s\n",i,global->FX320_imgFName[i]);
	...
	global->FX320_imgFName_read= g_new(pchar,8);
	global->FX320_imgFName_read[7]="/mnt_z10x/DCIM/100MEDIA/IMAG0008.JPG";
	global->FX320_imgFName_read[6]="/mnt_z10x/DCIM/100MEDIA/IMAG0007.JPG";
	global->FX320_imgFName_read[5]="/mnt_z10x/DCIM/100MEDIA/IMAG0006.JPG";
	global->FX320_imgFName_read[4]="/mnt_z10x/DCIM/100MEDIA/IMAG0005.JPG";
	global->FX320_imgFName_read[3]="/mnt_z10x/DCIM/100MEDIA/IMAG0004.JPG";
	global->FX320_imgFName_read[2]="/mnt_z10x/DCIM/100MEDIA/IMAG0003.JPG";
	global->FX320_imgFName_read[1]="/mnt_z10x/DCIM/100MEDIA/IMAG0002.JPG";
	global->FX320_imgFName_read[0]="/mnt_z10x/DCIM/100MEDIA/IMAG0001.JPG";

	global->FX320_image_inc=1;
//End of e-con
...
int closeGlobals(struct GLOBAL *global)
{
	...
	int i;
	g_free(global->FX320_imgFPath[1]);
	g_free(global->FX320_imgFPath[0]);
	g_free(global->FX320_imgFPath);
	for(i=0;i<8;i++){
		global->FX320_imgFName[i]= NULL;
		global->FX320_imgFName_read[i]= NULL;
		g_free(global->FX320_imgFName[i]);
		g_free(global->FX320_imgFName_read[i]);
	}
		g_free(global->FX320_imgFName);
		g_free(global->FX320_imgFName_read);
