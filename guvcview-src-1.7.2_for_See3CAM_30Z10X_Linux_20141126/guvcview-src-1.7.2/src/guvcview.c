...
//Start of e-con
        gtk_window_set_title (GTK_WINDOW (gwidget->mainwin), _("See3CAM GUVCViewer Controls"));
//End of e-con
    ...
    if(!(global->no_display))
    {
        ...
        gwidget->quitButton=gtk_button_new_with_label("Quit");
...
//Start of e-con
            g_signal_connect (GTK_WINDOW(gwidget->mainwin), "key_release_event", G_CALLBACK(key_released), &all_data);
//End of e-con
