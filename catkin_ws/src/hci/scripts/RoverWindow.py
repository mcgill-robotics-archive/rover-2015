...
#
# Created: Sun May  3 16:27:55 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_5.addWidget(self.MinimapLabel)
        ...
        self.Camera2Feed.addItem(_fromUtf8(""))
        self.Camera2Feed.addItem(_fromUtf8(""))
        self.gridLayout.addWidget(self.Camera2Feed, 1, 1, 1, 1)
        ...
        self.Camera3Feed.addItem(_fromUtf8(""))
        self.Camera3Feed.addItem(_fromUtf8(""))
        self.gridLayout.addWidget(self.Camera3Feed, 1, 2, 1, 1)
        ...
        self.verticalLayout_2.addWidget(self.OtherData)
        ...
        self.pointSteer = QtGui.QCheckBox(self.centralwidget)
        self.pointSteer.setObjectName(_fromUtf8("pointSteer"))
        self.horizontalLayout_6.addWidget(self.pointSteer)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "Top Screen", None))
        self.label_7.setText(_translate("MainWindow", "Bottom Screen", None))
